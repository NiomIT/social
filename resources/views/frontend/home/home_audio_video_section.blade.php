                ...
                <div class="post--item post--layout-1 post--type-video post--title-large">
                    <div class="post--img">
                        <a href="news-single-v1.html" class="thumb"><img
                                src="{{ asset('frontend') }}/assets/img/home-img/audio-video-01.jpg" alt=""></a>
                        ...
                        <div class="post--info">
                            ...
                            <div class="title">
                                <h2 class="h4"><a href="news-single-v1.html"
                                        class="btn-link">Standard chunk of Lorem Ipsum used since the
                                        1500s is reproduced below for those interested. Sections 1.10.32
                                        and 1.10.33 from "de Finibus Bonorum</a></h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul class="nav">
                    <li>
                        ...
                        <div class="post--item post--type-audio post--layout-3">
                            <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"><img
                                        src="{{ asset('frontend') }}/assets/img/home-img/audio-video-02.jpg" alt=""></a>
                    ...
                    <li>
                        ...
                        <div class="post--item post--type-video post--layout-3">
                            <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"><img
                                        src="{{ asset('frontend') }}/assets/img/home-img/audio-video-03.jpg" alt=""></a>
                    ...
                    <li>
                        ...
                        <div class="post--item post--type-video post--layout-3">
                            <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"><img
                                        src="{{ asset('frontend') }}/assets/img/home-img/audio-video-04.jpg" alt=""></a>
                    ...
                    <li>
                        ...
                        <div class="post--item post--type-audio post--layout-3">
                            <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"><img
                                        src="{{ asset('frontend') }}/assets/img/home-img/audio-video-05.jpg" alt=""></a>
