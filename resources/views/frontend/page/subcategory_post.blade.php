        ...
        <div class="container">
            @if (session()->get('language') == 'bangla')
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ route('category.post', $subcategory->category->slug) }}"
                            class="btn-link">{{ $subcategory->category->category_name_bn }}</a></li>
                    <li><a href="{{ route('subcategory.post', $subcategory->slug) }}"
                            class="btn-link">{{ $subcategory->subcategory_name_bn ?? '' }}</a></li>
                </ul>
            @else
                <ul class="breadcrumb">
                    <li><a href="/" class="btn-link"><i class="fa fm fa-home"></i>Home</a></li>
                    <li><a href="{{ route('category.post', $subcategory->category->slug) }}"
                            class="btn-link">{{ $subcategory->category->category_name_en }}</a></li>
                    <li><a href="{{ route('subcategory.post', $subcategory->slug) }}"
                            class="btn-link">{{ $subcategory->subcategory_name_en ?? '' }}</a></li>
                </ul>
            @endif
        </div>
    </div>
