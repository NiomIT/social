        ...
        <div class="container">
            @if (session()->get('language') == 'bangla')
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ route('hot.news') }}" class="btn-link"><i class="fa fm fa-home"></i>হট নিউজ </a></li>

                </ul>
            @else
                <ul class="breadcrumb">
                    <li><a href="/" class="btn-link"><i class="fa fm fa-home"></i>Home</a></li>
                    <li><a href="{{ route('hot.news') }}" class="btn-link"><i class="fa fm fa-home"></i>Hot News</a></li>
                </ul>
            @endif
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="sticky-content-inner">
                    ...
                    <div class="pagination--wrapper clearfix bdtop--1 bd--color-2 ptop--60 pbottom--30">
                        ...
                        <ul class="pagination float--right">
                            {{ $hot_news->links('pagination::bootstrap-4') }}
            ...
            <div class="main--sidebar col-md-4 ptop--30 pbottom--30" data-sticky-content="true">
                <div class="sticky-content-inner">
                    ...
                    <!-- Widget Start List Widgets hot news-->
