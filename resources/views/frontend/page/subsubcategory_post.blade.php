        ...
        <div class="container">
            @if (session()->get('language') == 'bangla')
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ route('category.post', $subsubcategory->category->slug) }}"
                            class="btn-link">{{ $subsubcategory->category->category_name_bn }}</a></li>

                    <li><a href="{{ route('subcategory.post', $subsubcategory->subcategory->slug) }}"
                            class="btn-link">{{ $subsubcategory->subcategory->subcategory_name_en ?? '' }}</a></li>
                    <li><a href="{{ route('subsubcategory.post', $subsubcategory->slug) }}"
                            class="btn-link">{{ $subsubcategory->sub_subcategory_name_bn ?? '' }}</a></li>
                </ul>
            @else
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ route('category.post', $subsubcategory->category->slug) }}"
                            class="btn-link">{{ $subsubcategory->category->category_name_en }}</a></li>

                    <li><a href="{{ route('subcategory.post', $subsubcategory->subcategory->slug) }}"
                            class="btn-link">{{ $subsubcategory->subcategory->subcategory_name_en ?? '' }}</a></li>

                    <li><a href="{{ route('subsubcategory.post', $subsubcategory->slug) }}"
                            class="btn-link">{{ $subsubcategory->sub_subcategory_name_en ?? '' }}</a></li>
                </ul>
            @endif
        </div>
    </div>
                                            ...
                                            @if (session()->get('language') == 'bangla')
                                                @if ($post->subsubcategory_id)
                                                    <a href="{{ route('subsubcategory.post', $post->subsubcategory->slug) }}"
                                                        class="cat">{{ $post->subsubcategory->sub_subcategory_name_bn }}</a>
                                                @elseif($post->subcategory_id)
                                                    <a href="{{ route('subcategory.post', $post->subcategory->slug) }}"
                                                        class="cat">{{ $post->subcategory->subcategory_name_bn }}</a>
                                                @else
                                                    <a href="{{ route('category.post', $post->category->slug) }}"
                                                        class="cat">{{ $post->category->category_name_bn }}</a>
                                                @endif
                                            @else
                                                @if ($post->subsubcategory_id)
                                                    <a href="{{ route('subsubcategory.post', $post->subsubcategory->slug) }}"
                                                        class="cat">{{ $post->subsubcategory->sub_subcategory_name_en }}</a>
                                                @elseif($post->subcategory_id)
                                                    <a href="{{ route('subcategory.post', $post->subcategory->slug) }}"
                                                        class="cat">{{ $post->subcategory->subcategory_name_en }}</a>
                                                @else
                                                    <a href="{{ route('category.post', $post->category->slug) }}"
                                                        class="cat">{{ $post->category->category_name_en }}</a>
                                                @endif
                                            @endif
