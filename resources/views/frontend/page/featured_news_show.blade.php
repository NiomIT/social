        ...
        <div class="container">
            @if (session()->get('language') == 'bangla')
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ route('featured.news') }}" class="btn-link"><i class="fa fm fa-home"></i>ফিচার নিউজ </a></li>

                </ul>
            @else
                <ul class="breadcrumb">
                    <li><a href="/" class="btn-link"><i class="fa fm fa-home"></i>Home</a></li>
                    <li><a href="{{ route('featured.news') }}" class="btn-link"><i class="fa fm fa-home"></i>Featured News</a></li>
                </ul>
            @endif
        </div>
    </div>
                ...
                <div class="sticky-content-inner">
                    ...
                    <div class="pagination--wrapper clearfix bdtop--1 bd--color-2 ptop--60 pbottom--30">
                        ...
                        <ul class="pagination float--right">
                            {{ $featured_news->links('pagination::bootstrap-4') }}
