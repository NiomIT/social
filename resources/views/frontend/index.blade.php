    ...
    <div class="row newsfeed-right-side-content mt-3">
        <div class="col-md-8 second-section   mx-auto" id="page-content-wrapper">
            ...
            <div class="posts-section mb-5">
                                        ...
                                        <a href="#" class="dropdown-item" aria-describedby="reportPost">
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <small id="reportPost" class="form-text text-muted">I'm concerned about
                                                        this post</small>
                                                </div>
                                            </div>
                                        </a>
                ...
                <div class="post border-bottom p-3 bg-white w-shadow">
                    <div class="media text-muted pt-3">
                        <img src="{{ 'frontend' }}/assets/images/users/user-2.jpg" alt="Online user"
                            class="mr-3 post-user-image">
                        <div class="media-body pb-3 mb-0 small lh-125">
                            <div class="d-flex justify-content-between align-items-center w-100">
                                        ...
                                        <a href="#" class="dropdown-item" aria-describedby="snoozePost">
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <small id="snoozePost" class="form-text text-muted">Temporarily stop
                                                        seeing posts</small>
                                                </div>
                                            </div>
                                        </a>
                ...
                <div class="post border-bottom p-3 bg-white w-shadow">
                    <div class="media text-muted pt-3">
                        <img src="{{ 'frontend' }}/assets/images/users/user-4.jpg" alt="Online user"
                            class="mr-3 post-user-image">
                        <div class="media-body pb-3 mb-0 small lh-125">
                            <div class="d-flex justify-content-between align-items-center w-100">
                                <a href="#" class="text-gray-dark post-user-name">Arthur
                                    Minasyan</a>
                                <div class="dropdown">
                                    <a href="#" class="post-more-settings" role="button" data-toggle="dropdown"
                                        id="postOptions" aria-haspopup="true" aria-expanded="false">
